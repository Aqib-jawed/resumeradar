      ...
      <div className="relative md:w-[45%] bg-[#111111] flex flex-col p-8 md:p-10 min-h-[300px] md:min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center py-12">
          ...
          <div className="border border-[#2a2a2a] rounded-xl p-5 max-w-[260px]">
            <div className="font-mono text-3xl font-bold text-accent mb-1">2,400+</div>
        ...
        <div className="flex-1 flex items-center justify-center px-6 pb-10">
          <div className="w-full max-w-[440px] space-y-5">
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-[#666666]">
                Enter your details to continue your analysis.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex justify-end">
                  <Link href="/forgot-password"
                    className="text-xs text-[#666666] underline underline-offset-2 hover:text-[#111]">
                    Forgot password?
                  </Link>
                </div>
              </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-3.5 bg-accent text-[#111111] font-black text-base rounded-xl hover:bg-[#d4f54a] active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
